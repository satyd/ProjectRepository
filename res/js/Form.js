    ...
    constructor(postCollection=[]) {
        ...
        this._postForm.innerHTML = `
			<section class="postheader" >
                ...
                <p class="author"></p>
                <p class="datetime"></p>
                <button class="nobg edit">
                    <img class="editin" src="res/images/edit.png" alt="">
                </button><br/>
            ...
            <section class="postfooter">
                <button class="nobg upv">
                    <img class="points pstyle" src="res/images/_upvote.png" alt="off">
                </button>
                <p class="pointz"></p>
                <button class="nobg downv">
                    <img class="points pstyle " src="res/images/downvote.png" alt="off">
                </button>
                <button class="nobg">
                    <img class="comment" src="res/images/comment.png" alt="">
                </button>
                <button class="nobg share">
                    <img class="share" src="res/images/share.png" alt="">
                </button>
            </section>
`;
    }
    ...
    ShowPostsFeed(postsFilling){
        ...
        for(let i = 0; i < postsFilling.length; i++){
            ...
            postForm.getElementsByClassName("postheader").id='id'+postForm.id;

            postForm.getElementsByClassName("editin").item(0).alt=postsToShow[i].author;
    ...
    add(postFilling) {
        ...
        postForm.getElementsByClassName("editin").item(0).alt=postToShow.author;
        console.log(postForm.getElementsByClassName("editin").item(0).alt);
    ...
    Clear()
    {
        ...
        while(this.size-->0)
        {
            let t=document.querySelector("div.post");
            if(t!=undefined)
                main.removeChild(t);
        }
    ...
    Remove(id) {
        ...
        let main = document.querySelector("section.posts");
        let t=document.querySelectorAll("div.post");
        for(let i=0;i<t.length;i++)
            {
                if(t[i].id==id)
                    {
                        main.removeChild(t[i]   );
                        break;
                    }
            }
